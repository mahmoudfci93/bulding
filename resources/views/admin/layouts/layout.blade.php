        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown tasks-menu" style="float: right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu"  style="right: auto ; left: 0">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li><!-- Task item -->
                                        <a href="{{url('/admin-panel/contact/'.$unreadMessage->id.'/edit')}}">
                                            <h3>
                                            {{$unreadMessage->name}}
                            ...
                            <li class="footer">
                                <a href="{{url('/admin-panel/contact')}}">اظهر كل الرسائل</a>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-right info">
                    ...
                    <a href="#"><i class="fa fa-circle text-success"></i> نشط الآن</a>
                </div>
            </div>
            <!-- search form -->
